...
import { ModalPlanejamentoNovoComponent } from './modal-planejamento/modal-planejamento-novo.component';

@Component({
  selector: 'app-planejamento-orcamentario-lista-novo',
  templateUrl: './planejamento-orcamentario-novo.component.html',
  styleUrls: ['./planejamento-orcamentario-novo.component.scss'],
})
export class PlanejamentoOrcamentarioNovoComponent implements OnInit {
  ...
  openModalPlanejamento(anoSelecionado: string) {
    const modalRef = this.modalService.open(ModalPlanejamentoNovoComponent, {
